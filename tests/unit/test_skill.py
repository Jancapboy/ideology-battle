...
class TestInvisibleHand:
    def test_buffs_ally(self) -> None:
        ...
        ally = Unit(
            id="ally", name="Ally", faction_tags=["经济系"], hp=50, max_hp=100, atk=10, spd=1.0
        )
...
class TestZeroSumGame:
    def test_steals_spd(self) -> None:
        ...
        enemy = Unit(
            id="en", name="Enemy", faction_tags=["技术系"], hp=100, max_hp=100, atk=10, spd=1.0
        )
...
class TestPopulistRhetoric:
    def test_heals_all_allies(self) -> None:
        ...
        caster = Unit(
            id="dem", name="民主", faction_tags=["政治系"], hp=100, max_hp=100, atk=10, spd=1.0
        )
...
class TestAlgorithmicOppression:
    def test_aoe_damage(self) -> None:
        ...
        caster = Unit(
            id="alg", name="算法推荐", faction_tags=["技术系"], hp=100, max_hp=100, atk=10, spd=1.0
        )
        enemies = [
...
class TestConsumerismFrenzy:
    def test_damage_and_heal(self) -> None:
        ...
        caster = Unit(
            id="con", name="消费主义", faction_tags=["经济系"], hp=80, max_hp=100, atk=10, spd=1.0
        )
        enemy = Unit(
            id="en", name="Enemy", faction_tags=["技术系"], hp=100, max_hp=100, atk=20, spd=1.0
        )
